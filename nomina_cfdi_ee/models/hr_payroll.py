            ...
            #periodo para nómina quincenal
               ...
               #calculo para nóminas semanales
                   ...
                   if contract.sept_dia: # septimo día
                      if contract.incapa_sept_dia:
                          aux = number_of_days + inc_days - proporcional
                      else:
                          aux = number_of_days - proporcional
                      if contract.semana_inglesa:
                          aux = aux / 5
                      else:
                          aux = aux / 6
    ...
    def _get_fondo_ahorro_anual(self):
        for payslip in self:
            ...
            if payslip.employee_id and payslip.contract_id.tablas_cfdi_id:
                date_start = date(fields.Date.from_string(payslip.date_from).year, 1, 1) #date(2019, 12, 30) #
